  ...
  useEffect(() => {
    const fetchShops = async () => {
      ...
      try {
        ...
        const options: ShopOption[] = (Array.isArray(data) ? data : []).map(
          (s: any) => ({
            id: s.id,
            name:
          ...
          <form className="create-product-form" onSubmit={handleSubmit}>
                ...
                <div className="form-group" style={{ width: "100%" }}>
                  ...
                  <select
                    ...
                    className={`form-input ${
                      errors.shop_id ? "form-input-error" : ""
                    }`}
                  >
            ...
            <div className="form-section">
              ...
              <p className="section-description">
                Upload ảnh sản phẩm lên Cloudinary. Bạn có thể upload nhiều ảnh
                cùng lúc.
              </p>
              <ImageUpload
