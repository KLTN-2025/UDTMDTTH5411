...
import ImageSearchResults from './pages/ImageSearchResults/ImageSearchResults';
...
import FloatingImageSearch from './components/FloatingImageSearch/FloatingImageSearch';
