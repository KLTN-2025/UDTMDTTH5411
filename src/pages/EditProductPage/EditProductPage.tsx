...
const EditProductPage: React.FC = () => {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    ...
    if (type === 'checkbox') {
      ...
      setFormData(prev => {
        ...
        if (name === 'price' && updated.original_price > 0 && numValue <= updated.original_price) {
          setErrors(prev => ({ ...prev, price: 'Giá bán phải cao hơn giá gốc (giá nhập hàng)' }));
        } else if (name === 'original_price' && updated.price > 0 && numValue >= updated.price) {
  ...
  const validateForm = () => {
    ...
    // Validate: Giá bán phải cao hơn giá gốc
    if (formData.price > 0 && formData.original_price > 0 && formData.price <= formData.original_price) {
            ...
            <div className="form-section">
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  <small className="form-hint">
                    ...
                    {formData.original_price > 0 && formData.price > formData.original_price && (
              ...
              <div className="form-group">
                ...
                <small className="form-hint">
                  ...
                  {formData.price > 0 && formData.discount_percentage > 0 && (
